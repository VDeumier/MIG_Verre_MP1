...
class nn_glass_mig_young_v2(base_app):
    def __init__(self):

        # Main parameters
        self.name = "nn_glass_mig_young_v2"
    ...
    def run(self):
        ...
        # Load dataset
        dts = dataset(pms(name="glass_mig_young_v2",
                          path="C:/Users/adelie.saule/MIG/hummingbird-master/hummingbird-master/hummingbird/dts/glass_mig_young_v2",
                          data=pms(type="array",
                                   filename="compoY_v2.csv",
                                   skiprows=1),
        ...
        net.dump("C:/Users/adelie.saule/MIG/Courbe_évolution_densité_SiO2_Na2O/net_young.txt")